...
const ExcelImportModal = ({ isOpen, onClose, campId, onImportComplete, importType = "families" }) => {
  ...
  const schemaDefinitions = importType === "families" ? {
    ...
    dob: { label: "تاريخ ميلاد رب الأسرة", required: false, aliases: ["تاريخ ميلاد رب الأسرة", "تاريخ ميلاد رب الاسرة", "تاريخ ميلاد الزوج", "تاريخ ميلاد المعيل", "تاريخ الميلاد", "تاريخ ميلاد", "الميلاد", "تاريخ الولادة", "سنة الميلاد", "تاريخ ميلاد الاب", "تاريخ ميلاد الأب", "تاريخ الميلاد لرب الأسرة", "dob", "birth_date", "birthdate"] },
    ...
    wifeDob: { label: "تاريخ ميلاد الزوجة", required: false, aliases: ["تاريخ ميلاد الزوجة", "تاريخ ميلاد الزوجه", "ميلاد الزوجة", "ميلاد الزوجه", "تاريخ ولادة الزوجة", "تاريخ ميلاد الزوجة الأولى", "تاريخ ميلاد الزوجه الاولى", "تاريخ ميلاد الام", "تاريخ ميلاد الأم", "تاريخ الميلاد للزوجة", "wife_dob", "wifedob"] },
    ...
    dob: { label: "تاريخ ميلاد رب الأسرة", required: false, aliases: ["تاريخ ميلاد رب الأسرة", "تاريخ ميلاد رب الاسرة", "تاريخ ميلاد الزوج", "تاريخ ميلاد المعيل", "تاريخ الميلاد", "تاريخ ميلاد", "الميلاد", "تاريخ الولادة", "سنة الميلاد", "dob", "birth_date"] },
    ...
    wifeDob: { label: "تاريخ ميلاد الزوجة", required: false, aliases: ["تاريخ ميلاد الزوجة", "تاريخ ميلاد الزوجه", "تاريخ ميلاد الزوجة الأولى", "ميلاد الزوجة", "ميلاد الزوجه", "تاريخ ولادة الزوجة", "wife_dob", "wifedob"] },
